...
const Calculator = () => {
  ...
  return (
    <div className="">
      <div className="w-60 h-20 bg-black text-white flex flex-col items-end justify-around p-2 break-words break-all">
        <div className="previous text-gray-500">465468768486</div>
        <div className="current text-2xl">64687486948</div>
      </div>
